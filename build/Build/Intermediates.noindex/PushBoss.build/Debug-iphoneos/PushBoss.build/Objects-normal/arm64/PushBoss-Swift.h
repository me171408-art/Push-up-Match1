...
#ifndef PUSHBOSS_SWIFT_H
#define PUSHBOSS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PushBoss",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8PushBoss13CameraManager")
...
@interface CameraManager (SWIFT_EXTENSION(PushBoss)) <AVCaptureVideoDataOutputSampleBufferDelegate>
