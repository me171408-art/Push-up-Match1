...
#ifndef PUSHUPMATCH_SWIFT_H
#define PUSHUPMATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PushUpMatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11PushUpMatch13CameraManager")
...
@interface CameraManager (SWIFT_EXTENSION(PushUpMatch)) <AVCaptureVideoDataOutputSampleBufferDelegate>
